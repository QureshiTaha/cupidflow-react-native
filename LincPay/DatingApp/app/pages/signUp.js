...
console.log("API URL ==> ", process.env.EXPO_PUBLIC_API_BASE_URL);
  ...
  console.log(error.config);
          if (error.response.data.msg) {
            ...
            toast.show(`❌ ${error.response.data.msg}`, { type: "danger", placement: "top" });
          } else if (error.response.data.data.message) {
            toast.show(`❌ ${error.response.data.message}`, { type: "danger", placement: "top" });
          } else {
            toast.show(`❌ ${error.toString()}`, { type: "danger", placement: "top" });
          }
          setIsValidating(false);
        });
    } catch (err) {
