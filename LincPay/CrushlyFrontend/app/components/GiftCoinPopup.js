        ...
        <View style={styles.popupContainer}>
          ...
          <View style={styles.coinOptions}>
            {coinOptions.map((amount) => (
              ...
              >
                <Text style={[styles.coinText,{ color:selectedAmount === amount ? "#fff":themeColors.color4}]}>{amount} coins</Text>
              </TouchableOpacity>
            ))}
          </View>
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity style={styles.cancelButton} onPress={onClose}>
              <Text style={[styles.buttonText,{color:themeColors.color2}]}>Cancel</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[
                styles.sendButton,
            ...
            >
              {loading ? (
                ...
                <Text style={[styles.buttonText,{color:'#fff'}]}>Send Gift</Text>
              )}
            </TouchableOpacity>
          </View>
        </View>
